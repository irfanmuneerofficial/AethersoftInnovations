        ...
        $pages = [
            ...
            [
                ...
                'content' =>
                    ...
                    Html::tag(
                        'div',
                        '[how-to-start title="Bring your target users together on social media" subtitle=" Business Platform" image="general/banner-how-to-start.png" image_icon_primary="icons/certify.png" image_icon_secondary="icons/fly.png" style="style-2" quantity="3" title_1="Create an account" description_1="What makes us different from others? We give holistic solutions with strategy, design & technology." title_2="Build your founding team" description_2="What makes us different from others? We give holistic solutions with strategy, design & technology." title_3="Launch and Scale" description_3="What makes us different from others? We give holistic solutions with strategy, design & technology."][/how-to-start]'
                    ) .
                    Html::tag(
                        'div',
                    ...
                    Html::tag(
                        'div',
                        '[teams title="Meet the amazing team behind " subtitle="Our leadership team" team_ids="1,2,3,5"][/teams]'
                    ) .
                    Html::tag(
                        'div',
            ...
            [
                ...
                'content' =>
                    Html::tag(
                        'div',
                        '[contact-page-banner title="We’d love to hear from you" subtitle="Get in Touch" description="Request a demo, ask a question, or get in touch here. If you’re interested in working at  Corporation, check out our {{careers page}}." button_label="Learn More" button_url="/about-us" banner="general/contact-banner.png" quantity="2" title_1="Appstore" image_1="general/apple.png" title_2="Googleplay" image_2="general/google.png"][/contact-page-banner]'
                    ) .
                    Html::tag(
                        'div',
            ...
            [
                ...
                'content' =>
                    ...
                    Html::tag(
                        'div',
                        '[from-community-forums title="From Community Forums" subtitle="Updated on September 24, 2023" quantity="6" title_1=" Announcements" description_1="Seamless importing and round-tripping of Microsoft Project plans, Excel files & CSV files." image_1="icons/cross-platform.png" topics_1="3" comments_1="16" account_1="1" title_2=" User Feedback" description_2="Seamless importing and round-tripping of Microsoft Project plans, Excel files & CSV files." image_2="icons/creation.png" topics_2="3" comments_2="19" account_2="3" title_3="Technology support center" description_3="Seamless importing and round-tripping of Microsoft Project plans, Excel files & CSV files." image_3="icons/cross-platform.png" topics_3="5" comments_3="9" account_3="1" title_4=" Product Support" description_4="Seamless importing and round-tripping of Microsoft Project plans, Excel files & CSV files." image_4="icons/cross-platform.png" topics_4="5" comments_4="7" account_4="3" title_5=" Cognitive Solution" description_5="Seamless importing and round-tripping of Microsoft Project plans, Excel files & CSV files." image_5="icons/cross-platform.png" topics_5="6" comments_5="2" account_5="4" title_6="Market research" description_6="Seamless importing and round-tripping of Microsoft Project plans, Excel files & CSV files." image_6="icons/certification.png" topics_6="2" comments_6="1" account_6="5"][/from-community-forums]'
                    ) .
                    Html::tag(
                        'div',
            ...
            [
                ...
                'content' =>
                    Html::tag(
                        'div',
                        '[banner-hero-with-teams title="Customers Love Our Creative Team, and So Will You" description="“Highly recommend  Agency! They guide us on marketing initiatives and develop great strategies to increase our return on investment. The agency is excellent at being cooperative and responding quickly.”" button_primary_label="Contact Us" button_primary_url="/contact" button_secondary_label="Support Center" button_secondary_url="/contact" team_ids="1,2,3,4,5" style="style-2"][/banner-hero-with-teams]'
                    ) .
                    Html::tag(
                        'div',
