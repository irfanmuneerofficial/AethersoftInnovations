...
return new class () extends Migration {
    ...
    {
        Schema::create('bs_service_categories', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('bs_services', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::create('bs_packages', function (Blueprint $table): void {
            $table->id();
            $table->string('name');
            $table->string('description', 400)->nullable();
            $table->text('content');
        ...
        Schema::create('bs_service_categories_translations', function (Blueprint $table): void {
        ...
        Schema::create('bs_services_translations', function (Blueprint $table): void {
            $table->string('lang_code');
        ...
        Schema::create('bs_packages_translations', function (Blueprint $table): void {
            $table->string('lang_code');
