    ...
    <div class="card">
        ...
        <div class="card-content p-4">
            <form class="input-group rounded" action="{{ route('public.search') }}" method="get">
                <input type="search" name="q" class="form-control rounded-start" value="{{ BaseHelper::stringify(request()->query('q')) }}" placeholder="{{ __('Search') }}" aria-label="{{ __('Search') }}" aria-describedby="search-addon" />
