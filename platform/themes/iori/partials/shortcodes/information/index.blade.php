@php
    $backgroundImage = $shortcode->background_image ? RvMedia::getImageUrl($shortcode->background_image) : '../imgs/page/about/circle.png';
    $backgroundImage1 = $shortcode->background_image_1 ? RvMedia::getImageUrl($shortcode->background_image_1) : '../imgs/page/about/arrow-down.png';
@endphp

<section class="section pb-50 bg-core-value" style="background-image: url('{{ $backgroundImage }}') !important;">
    <div class="container">
        <div class="row box-list-core-value">
            <div class="col-lg-4 mb-40">
                <div class="box-core-value">
                    <div class="shape-left shape-1" style="--background-image: url('{{ $backgroundImage1 }}');"></div>
